      ...
      <header className="sticky top-0 z-40 bg-surface-300/80 backdrop-blur-xl border-b border-surface-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-xs font-semibold text-slate-300">
            <Link href="#method" className="hover:text-white transition-colors">Framework</Link>
            <Link href="/blueprint" className="hover:text-white transition-colors">Blueprint</Link>
            <Link href="/studio" className="hover:text-white transition-colors">AI Studio</Link>
